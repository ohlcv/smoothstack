...
class DependencyManager:
    ...
    def list_packages(self, installer_type: str = "pip", **kwargs) -> List[Dict]:
        """
        列出已安装的依赖包
    ...
    def check_updates(self, installer_type: str = "pip", **kwargs) -> List[Dict]:
        """
        检查依赖包更新
        ...
        try:
            installer = self.installers[installer_type]
            return installer.check_updates(source=source, **kwargs)
        except Exception as e:
